...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <%--Password--%>
        <form:form action="${url_edit_password}" method="post" role="form" class="form-horizontal">
            <div class="form-group">
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <%--Address--%>
        <form:form action="${url_edit_address}" method="post" role="form" class="form-horizontal">
            <div class="form-group">
        ...
        <%--Email--%>
        <form:form action="${url_edit_email}"  method="post" role="form" class="form-horizontal">
            <div class="form-group">
        ...
        <%--Phone--%>
        <form:form action="${url_edit_phone}" method="post" role="form" class="form-horizontal">
            <div class="form-group">
