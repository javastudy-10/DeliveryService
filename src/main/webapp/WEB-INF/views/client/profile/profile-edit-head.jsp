...
<script src="<c:url value="/resources/js/profile/profile.js"/>" type="text/javascript"><jsp:text/></script>
...
<c:if test="${param.get('flag') == 'address'}">
    <script type="text/javascript" src="<c:url value="/resources/js/profile/profile-edit-address.js" />" >
        <jsp:text/>
    </script>
...
<c:if test="${param.get('flag') == 'email'}">
    <script type="text/javascript" src="<c:url value="/resources/js/profile/profile-edit-email.js" />" >
        <jsp:text/>
    </script>
...
<c:if test="${param.get('flag') == 'phone'}">
    <script type="text/javascript" src="<c:url value="/resources/js/profile/profile-edit-phone.js" />" >
        <jsp:text/>
    </script>
...
<c:if test="${param.get('flag') == 'password'}">
    <script type="text/javascript" src="<c:url value="/resources/js/profile/profile-edit-password.js" />" >
        <jsp:text/>
    </script>
